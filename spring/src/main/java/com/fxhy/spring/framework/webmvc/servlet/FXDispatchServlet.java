...
import com.fxhy.spring.framework.annotation.FXRequestMapping;
...
//                }else if(clazz.isAnnotationPresent(FXService.class)){
//                    //1、在多个包下出现相同的类名，只能寄几（自己）起一个全局唯一的名字
//                    //自定义命名
//                    String beanName = clazz.getAnnotation(FXService.class).value();
